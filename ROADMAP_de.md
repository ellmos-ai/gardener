...
- [x] Blob-Halde für große Dateien (>50MB)
- [x] Workspace-Materialisierung für Code-Ausführung
...
Tools, Skills und Wissenseinträge sollen wie Memory-Einträge
altern und frisch bleiben können:

- **Decay für alles:** Nicht nur memory/lesson/session, sondern auch
  tools und knowledge bekommen Gewicht. Unbenutzte Tools verblassen,
  oft genutzte bleiben frisch.
- **Nutzungs-Tracking:** `run()` erhöht das Gewicht eines Tools.
  `get()` erhöht das Gewicht von Knowledge. Wer gebraucht wird, lebt.
- **Natürliche Selektion:** Wenn ein besseres Tool für die gleiche
